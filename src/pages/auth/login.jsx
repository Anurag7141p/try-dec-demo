      ...
      <div className="flex flex-col w-full h-full  ">
        ...
        <div className="flex justify-center items-center pt-10">
          <div className=" flex h-full  w-[70%] justify-center items-center  border border-blue-400 rounded-xl ">
            ...
            <div className="w-1/2  h-full py-10   bg-gradient-to-r from-cyan-500 to-blue-500 rounded-r-lg">
              <div className="flex flex-col justify-between mx-10  bg-gray-300/50 rounded-xl  md:px-2 lg:px-5 h-full">
