...
import { LuArrowDownUp, LuMessageSquare } from "react-icons/lu";
...
const MobFooter = () => {
  return (
    <div className="xs:h-28 xs:w-full flex text-xl font-lato  border-2 rounded-2xl items-center justify-around fixed bottom-0  bg-white ">
      <div className="hover:bg-blue-600 px-3 h-full  flex justify-center items-center  rounded-tr-lg rounded-br-lg rounded-bl-lg hover:pb-4">
        <RiHomeLine className=" w-9 h-9 text-blue-600 hover:text-white" />
      </div>
      <div className="hover:bg-blue-600 px-3 h-full  flex justify-center items-center  rounded-tr-lg rounded-br-lg rounded-bl-lg hover:pb-4">
        <LuMessageSquare className="w-7 h-7 text-blue-600 hover:text-white" />
      </div>
      <div className="hover:bg-blue-600 px-3 h-full  flex justify-center items-center  rounded-tr-lg rounded-br-lg rounded-bl-lg hover:pb-4 ">
