...
import UserNav from "../reusable/navbar/userNav";
import cameraData from "../../data/landingpagedata/bestRentalData/cameraData";
import Userprofilecard from "../reusable/card/userprofilecard";
import { FaPlus } from "react-icons/fa6";
import Footer from "../reusable/footer/footer/footer";
import Sidebar from "../reusable/navbar/sidebar";
...
const InventoryDemo = ({ categoryList }) => {
      ...
      <div className="flex ">
        ...
        <div className="flex-1 bg-blue-50">
            ...
            <div className="flex border border-gray-300 rounded py-4 lg:w-full lg:h-[130px] ">
              <div className="relative">
                ...
                <img
                  src={level1}
                  alt=""
                  className="h-6 w-6 absolute top-9 right-0 "
                />
              </div>
              ...
              <div className="lg:flex flex-col ml-12 mr-4">
                <button className="bg-gray-400 text-white rounded px-2 py-2 hover:bg-blue-700 mb-4 md:h-10 md:text-sm transition duration-300 transform hover:-translate-y-0.5">
                  Complete Verification
                </button>
                <button className="bg-gray-400 text-white rounded px-2 py-2 hover-bg-blue-700 transition duration-300 transform hover:-translate-y-0.5">
                  Store not available
                </button>
              </div>
            </div>
          ...
          <div className="flex">
            ...
            {edit ? (
              <EditProduct categoryList={categoryList.productData}/>
            ) : (
                  ...
                  <div className="mb-4 md:mb-0 mx-auto">
                    ...
                    >
                      <div className="border border-blue-400 px-6 lg:w-48 lg:mr-32 h-20 py-2 mt-1 rounded text-center">
                        <FaPlus
                          size={14}
                          className="text-blue-500 mb-1 mx-auto mt-4"
                        />
                        <p className="mx-auto text-blue-500 font-medium">
                          Add Product
                        </p>
                      </div>
                      <input
