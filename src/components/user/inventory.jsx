            ...
            <div className="flex ">
                ...
                <div className='flex-1  bg-blue-100'>
                    ...
                    <div className='flex'>
                        ...
                        <div className='card-box bg-white rounded py-4  mt-6 mx-4 px-4 lg:ms-6'>
                            <div className='flex border border-gray-500 rounded-lg px-2 relative w-60 ml-auto lg:mr-[230px] mt-2'>
                                <input
                                    type="text"
                                    placeholder="Search..."
                                    className="outline-none"
                                />
                                <button className="absolute right-0 top-0 bottom-0 bg-blue-500 text-white rounded-r px-3">
                                    <IoSearch />
                                </button>

                                <button className="bg-blue-500 text-white rounded px-2 py-1 flex items-center ml-16 ">
                                    <IoSearch />
                            ...
                            <div className='card-box bg-white rounded py-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4  md:ms-4'>
                                <div className='mb-4 md:mb-0'>
                                    <label htmlFor='imageUpload' className='flex flex-col items-center cursor-pointer'>
                                        <div className='border border-blue-400 px-6 lg:w-48 lg:mr-32 h-20 py-2 mt-1 rounded text-center md:ml-28'>
