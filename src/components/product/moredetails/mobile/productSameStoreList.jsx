...
const ProductSameStoreList = () => {
  ...
  return (
    <div className="overflow-x-auto pb-2 w-full">
      <div className="flex  w-full  px-3 mt-8 gap-3 ">
        {product.map((curElem,index) => (
          <div key={index} className="w-full">
            <div className="w-44 font-frank flex flex-col gap-2 h-80 bg-gray-50 border border-gray-300 rounded-lg shadow-xl">
              <div>
                <img
...
export default ProductSameStoreList;
