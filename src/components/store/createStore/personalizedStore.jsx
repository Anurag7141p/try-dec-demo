...
import { storeFullInitialValues } from "./storeCreateInitialValues";
          ...
          >
            <Form>
              <div className="grid grid-cols-9 gap-3">
                <div className="col-span-6 md:col-span-9 xs:col-span-9 text-[14px]  lg:col-span-6  grid grid-cols-6 gap-4    md:h-full xl:p-3">
                    ...
                    <div className="w-full  bg-white">
                      ...
                      <div className=" h-fit w-full flex ">
                        <p className="font-sans text-gray-500 ml-2 mt-1.5 w-[65%]">
                          Effortlessly manage product pickup and drop-off with
                          our user-friendly store working hour setup
                        </p>
                      </div>
                        ...
                        <div className=" flex flex-row  md:flex-row md:items-start md:justify-start md:space-x-3 lg:space-x-0.5 mt-4 md:mt-6 lg:mt-4">
                          <div className="">
                            <button
                              ...
                              className="bg-blue-500 w-8 rounded-l-lg text-white py-1 p-0 "
                            >
                              {fromHours}
                            </button>
                            <button
                          ...
                          <button
                            ...
                            className="bg-blue-500 rounded-r-lg w-12 ml-0.5 text-white py-1 pr-1"
                          >
                            {fromAmPm}
                          </button>
                      ...
                      {image ? (
                        <div className="w-full h-fit flex justify-center items-center relative mb-3 mx-2">
                          <img
                            className="w-auto h-60 object-cover pt-3"
                        ...
                        <div className="h-fit w-full flex ">
                          <div className="mt-8 ">
                            ...
                            <p className="text-gray-400 text-sm text-center flex items-center justify-center md:text-left mt-2">
                              Attach an image file (JPG, PNG) with a size less
                              than 5MB.
                            </p>
                ...
                <div className="col-span-3 bg-blue-600 xl:min-h-[800px] md:min-h-screen  lg:block md:hidden xs:hidden  rounded-2xl px-10 pt-20 text-white   ">
                  <div className="flex flex-col justify-around h-1/2">
                    ...
                    <button className="px-8 py-1 mt-10 bg-white text-black rounded-lg w-20 flex justify-center">
                      Next
                    </button>
                  </div>
                </div>
