...
const StoreDetails = ({ setFieldValue, currentPage, pages }) => {
  ...
  //     console.log(data, "store usr data");
  //   }
  // }, [data]);
              ...
              <div className="col-span-3 lg:col-span-3 md:col-span-6 xs:col-span-6 flex flex-col gap-6 ">
                ...
                <div className="flex flex-col gap-2">
                  <div className="relative flex flex-col gap-3 ">
                    <label className="font-semibold">Select Store Type </label>
            ...
            <div className="col-span-3 bg-blue-600 xl:min-h-[800px] lg:block md:hidden xs:hidden  rounded-2xl px-10 pt-20 text-white   ">
              <div className="h-1/2 flex flex-col justify-between">
                ...
                {currentPage == 1 ? (
                  <button
                    type="submit"
                    className="px-8 py-1 mt-10  flex justify-center bg-white text-black rounded-lg"
                  >
                    Next
                  </button>
                ) : null}
