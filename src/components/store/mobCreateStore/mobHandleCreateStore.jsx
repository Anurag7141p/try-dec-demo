...
import MobCreateStoreForm from "./mobCreateStoreForm";
import { storeFormSchema } from "../../../validation/storeYup";
import {
  createStoreFormInitialValues,
  storeFullInitialValues,
} from "../createStore/storeCreateInitialValues";
import { storeShema } from "../../../validation/yup";
import MobCreateStorePersonalize from "./mobCreateStorePersonalize";
...
const MobHandleCreateStore = () => {
  ...
  const handleSubmit = async (values) => {
    // setLoad(true);
    // try {
    //   const { message, storeData, userData } = await createStoreApi(
    //     values,
    //     values.image
    //   );
    //   if (message == "success") {
    ...
    //     }
    //     if (userData) {
    //       dispatch(updatedUserData(userData));
    //     }
    //     handleNextPage(3);
    //     setLoad(false);
  ...
  //           initialValues={documentInitioalValues}
  //           handleSubmit={handleDocumentSubmit}
  //           FormComponent={StoreDocumentVerificationForm}
  //           boxTittle={boxTittle}
...
export default MobHandleCreateStore;
