...
const Userprofilecard = ({ imageUrl, name, money }) => {
  return (
    <div className=' mb-3 lg:mr-3 sm:mr-[14px]'>
      {/* Image container */}
      <div className='border border-gray-500 h-20 py-2 lg:w-48 sm:w-40  mt-1 rounded flex items-center rounded-lg justify-start overflow-hidden relative'>
        {/* New tag in top-left corner */}
        <div className='absolute top-0 left-0 bg-green-500 text-white text-sm rounded'>New</div>

        {/* Image */}
        <img src={imageUrl} alt="" className='w-[70px] h-[78px] rounded-l-lg' />
